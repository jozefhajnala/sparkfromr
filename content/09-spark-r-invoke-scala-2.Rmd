...
> If you did not do so, it is recommended to read the [previous part](https://jozef.io/r204-spark-r-invoke-scala/) of this series before this one to get a quick overview of the `invoke()` API.
