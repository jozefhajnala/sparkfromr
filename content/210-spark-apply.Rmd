...
In this chapter we will look into the `spark_apply()` interface and how it communicates with the Spark instance.

As an example we will try to rewrite the function from the previous chapter allowing to use the non-translated `casefold()`.
