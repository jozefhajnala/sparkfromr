...
For the purpose of this book, a [Docker image](https://hub.docker.com/repository/docker/jozefhajnala/sparkfromr) was built which you can use to run all the code chunks present in it withouth issues.
...
After running the above line, open your favourite web browser such as Google Chrome or Firefox and navigate to http://localhost:8787. You should be greeted by the RStudio login screen where you can use the following to login:
